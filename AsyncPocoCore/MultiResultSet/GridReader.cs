...
namespace AsyncPoco.MultiResultSet
{
    ...
    public class GridReader : IDisposable
    {
        ...
        private IEnumerable<T> SinglePocoFromIDataReader<T>(int index)
        {
            ...
            try
            {
                ...
                {
                    var factory =
                        pd.GetFactory(_command.CommandText, _command.Connection.ConnectionString, 0, _reader.FieldCount, _reader) as Func<IDataReader, T>;
