...
namespace AsyncPoco.Attributes.Special
{
    ...
    public class SearchableGroupAttribute : Attribute
    {
        public SearchableGroupAttribute(string groupName, int groupOrderIndex, int fieldOrderIndex, string description)
            : this(groupName, groupOrderIndex, fieldOrderIndex, description, Enum_FieldRole.NONE)
        {
            
        }

        public SearchableGroupAttribute(string groupName, int groupOrderIndex, int fieldOrderIndex, string description, Enum_FieldRole fieldRole)
        {
