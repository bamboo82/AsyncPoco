...
using AsyncPoco.MultiResultSet;
...
namespace AsyncPoco
{
    ...
    public class Database : IDisposable
    {
        ...
        public async Task<Page<TRet>> PageAsync<T1, T2, TRet>(Func<T1, T2, TRet> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            // Save the one-time command time out and use it for both queries
            var saveTimeout = OneTimeCommandTimeout;
        ...
        public async Task<Page<TRet>> PageAsync<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            // Save the one-time command time out and use it for both queries
            var saveTimeout = OneTimeCommandTimeout;
        ...
        public async Task<Page<TRet>> PageAsync<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            // Save the one-time command time out and use it for both queries
            var saveTimeout = OneTimeCommandTimeout;
        ...
        public async Task<Page<TRet>> PageAsync<T1, T2, T3, T4, T5, TRet>(Func<T1, T2, T3, T4, T5, TRet> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            // Save the one-time command time out and use it for both queries
            var saveTimeout = OneTimeCommandTimeout;
        ...
        public async Task<Page<TRet>> PageAsync<T1, T2, T3, T4, T5, T6, TRet>(Func<T1, T2, T3, T4, T5, T6, TRet> cb, long page, long itemsPerPage, string sqlCount, object[] countArgs, string sqlPage, object[] pageArgs)
        {
            // Save the one-time command time out and use it for both queries
            var saveTimeout = OneTimeCommandTimeout;
        ...
        public Task<Page<TRet>> PageAsync<T1, T2, TRet>(Func<T1, T2, TRet> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            var args = sql.Arguments;
            BuildPageQueries<TRet>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref args, out sqlCount, out sqlPage);

            return PageAsync<T1, T2, TRet>(cb, page, itemsPerPage, sqlCount, args, sqlPage, args);
        }
        public Task<Page<TRet>> PageAsync<T1, T2, T3, TRet>(Func<T1, T2, T3, TRet> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            var args = sql.Arguments;
            BuildPageQueries<TRet>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref args, out sqlCount, out sqlPage);

            return PageAsync<T1, T2, T3, TRet>(cb, page, itemsPerPage, sqlCount, args, sqlPage, args);
        }
        public Task<Page<TRet>> PageAsync<T1, T2, T3, T4, TRet>(Func<T1, T2, T3, T4, TRet> cb, long page, long itemsPerPage, Sql sql)
        {
            string sqlCount, sqlPage;
            var args = sql.Arguments;
            BuildPageQueries<TRet>((page - 1) * itemsPerPage, itemsPerPage, sql.SQL, ref args, out sqlCount, out sqlPage);

            return PageAsync<T1, T2, T3, T4, TRet>(cb, page, itemsPerPage, sqlCount, args, sqlPage, args);
        }
        ...
        public class InsertOptions : Options
        {
            public bool AllowInsertTrigger { get; set; } = false;
        ...
        public virtual async Task<object> InsertAsync(string tableName, string primaryKeyName, bool autoIncrement, object poco, IEnumerable<string> columns = null, InsertOptions insertOptions = null)
        {
            if (insertOptions == null)
            {
                insertOptions = new InsertOptions(); // default options
            }
            ...
            try
            {
                ...
                try
                {
                    using (var cmd = CreateCommand(_sharedConnection, ""))
                    {
                        ...
                        if (!autoIncrement) /* No-AutoIncrement */
                        {
                            ...
                            PocoColumn pc;
                            if (primaryKeyName != null && pd.Columns.TryGetValue(primaryKeyName, out pc))
                        ...
                        else  /* AutoIncrement */
                        {
                            ...
                            //don't use output inserted technique yet
                            //need equalvant ExecuteInsertAsync to work
                            //if (autoIncrement)
                            //{
                            ...
                            // Execute and getback inserted id value
        ...
        public bool IsNew(object poco)
        {
            ...
            //    throw new InvalidOperationException("IsNew() and Save() are only supported on tables with primary key columns");
        ...
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, TRet>(Func<T1, T2, T3, T4, T5, TRet> cb, string sql, params object[] args)
        {
            return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, cb, sql, args);
        }
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, T6, TRet>(Func<T1, T2, T3, T4, T5, T6, TRet> cb, string sql, params object[] args)
        {
            return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, cb, sql, args);
        }
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, T6, T7, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, TRet> cb, string sql, params object[] args)
        {
            return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, cb, sql, args);
        }
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, T6, T7, T8, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TRet> cb, string sql, params object[] args)
        {
            return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, cb, sql, args);
        }
        ...
        public Task QueryAsync<T1, T2, T3, T4, T5, TRet>(Func<T1, T2, T3, T4, T5, TRet> cb, string sql, object[] args, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, cb, sql, args, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, TRet>(Func<T1, T2, T3, T4, T5, T6, TRet> cb, string sql, object[] args, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, cb, sql, args, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, TRet> cb, string sql, object[] args, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, cb, sql, args, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7, T8, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TRet> cb, string sql, object[] args, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, cb, sql, args, action); }
        ...
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, TRet>(Func<T1, T2, T3, T4, T5, TRet> cb, Sql sql) { return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, cb, sql.SQL, sql.Arguments); }
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, T6, TRet>(Func<T1, T2, T3, T4, T5, T6, TRet> cb, Sql sql) { return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, cb, sql.SQL, sql.Arguments); }
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, T6, T7, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, TRet> cb, Sql sql) { return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, cb, sql.SQL, sql.Arguments); }
        public Task<List<TRet>> FetchAsync<T1, T2, T3, T4, T5, T6, T7, T8, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TRet> cb, Sql sql) { return FetchAsync<TRet>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T8) }, cb, sql.SQL, sql.Arguments); }
        ...
        public Task QueryAsync<T1, T2, T3, T4, T5, TRet>(Func<T1, T2, T3, T4, T5, TRet> cb, Sql sql, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, cb, sql.SQL, sql.Arguments, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, TRet>(Func<T1, T2, T3, T4, T5, T6, TRet> cb, Sql sql, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, cb, sql.SQL, sql.Arguments, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, TRet> cb, Sql sql, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, cb, sql.SQL, sql.Arguments, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7, T8, TRet>(Func<T1, T2, T3, T4, T5, T6, T7, T8, TRet> cb, Sql sql, Action<TRet> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, cb, sql.SQL, sql.Arguments, action); }
        ...
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5>(string sql, params object[] args) { return FetchAsync<T1>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, null, sql, args); }
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5, T6>(string sql, params object[] args) { return FetchAsync<T1>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, null, sql, args); }
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5, T6, T7>(string sql, params object[] args) { return FetchAsync<T1>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, null, sql, args); }
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5, T6, T7, T8>(string sql, params object[] args) { return FetchAsync<T1>(new[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, null, sql, args); }
        ...
        public Task QueryAsync<T1, T2, T3, T4, T5>(string sql, object[] args, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, null, sql, args, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6>(string sql, object[] args, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, null, sql, args, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7>(string sql, object[] args, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, null, sql, args, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7, T8>(string sql, object[] args, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, null, sql, args, action); }
        ...
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5>(Sql sql) { return FetchAsync<T1, T2, T3, T4, T5>(sql.SQL, sql.Arguments); }
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5, T6>(Sql sql) { return FetchAsync<T1, T2, T3, T4, T5, T6>(sql.SQL, sql.Arguments); }
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5, T6, T7>(Sql sql) { return FetchAsync<T1, T2, T3, T4, T5, T6, T7>(sql.SQL, sql.Arguments); }
        public Task<List<T1>> FetchAsync<T1, T2, T3, T4, T5, T6, T7, T8>(Sql sql) { return FetchAsync<T1, T2, T3, T4, T5, T6, T7, T8>(sql.SQL, sql.Arguments); }
        ...
        public Task QueryAsync<T1, T2, T3, T4, T5>(Sql sql, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5) }, null, sql.SQL, sql.Arguments, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6>(Sql sql, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6) }, null, sql.SQL, sql.Arguments, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7>(Sql sql, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7) }, null, sql.SQL, sql.Arguments, action); }
        public Task QueryAsync<T1, T2, T3, T4, T5, T6, T7, T8>(Sql sql, Action<T1> action) { return QueryAsync(new Type[] { typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8) }, null, sql.SQL, sql.Arguments, action); }
        ...
        private Dictionary<string, object> GetPrimaryKeyValues(string primaryKeyName, object primaryKeyValue)
        {
            ...
            if (primaryKeyValue != null)
            {
                ...
                if (multiplePrimaryKeysNames.Length == 1)  // singular-key
                {
        ...
        #region MultiResultSet 
        /// <summary>
        /// Perform a multi-results set query
        /// </summary>
        /// <param name="sql">An SQL builder object representing the query and it's arguments</param>
        /// <returns>A GridReader to be queried</returns>
        public Task<GridReader> QueryMultipleAsync(Sql sql)
        {
            return QueryMultipleAsync(sql.SQL, sql.Arguments);
        }
